...
app_choice = st.sidebar.selectbox(
    "Select Application",
    [
        "Rwanda EV Policy Simulator",
        "SmartDash MVP – Kigali EV Dashboard"
    ]
)

# ===================================================
# APP 1: RWANDA EV POLICY SIMULATOR
# ===================================================
def rwanda_ev_policy_simulator():
    import streamlit as st
    import pandas as pd
    ...
    if selected_tab == "Scenario Simulator":
        ...
        with tab4:
            ...
            financial_recs = [r for r in recommendations if any(keyword in r.get('category', '').lower()
                                                                for keyword in
                                                                ['financial', 'incentive', 'investment'])]
        ...
        charger_power = st.select_slider("Average Charger Power (kW)", [10, 15, 20, 50], value=20,
                                         key="grid_charger_power")
...
# ===================================================
# APP 2: SMARTDASH MVP – KIGALI EV DASHBOARD
# ===================================================
def smartdash_mvp():
    import streamlit as st
    import pandas as pd
...
# APP ROUTER
# ===================================================
if app_choice == "Rwanda EV Policy Simulator":
    rwanda_ev_policy_simulator()

elif app_choice == "SmartDash MVP – Kigali EV Dashboard":
    smartdash_mvp()
